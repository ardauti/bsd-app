...
import {Dropdown, DropdownContent, DropdownItem, DropdownMenu, DropdownToggle} from "@/components";
...
export default function FileManager() {
    ...
    const filteredFiles = files.filter((file) => {
        if (selectedCategory === "images") {
            return file.files[0].type === "Image";
        } else if (selectedCategory === "videos") {
            return file.files[0].type === "Video";
        } else if (selectedCategory === "files") {
            return file.files[0].type !== "Image" && file.files[0].type !== "Video";
        }
        return false;
    });
                        ...
                        <div className="mt-1">
                            <a
                                ...
                                className={`flex items-center px-3 py-2 rounded-md ${
                                    selectedCategory === "images" ? "bg-primary text-white" : ""
                                }`}
                            >
                            ...
                            <a
                                ...
                                className={`flex items-center px-3 py-2 mt-2 rounded-md ${
                                    selectedCategory === "videos" ? "bg-primary text-white" : ""
                                }`}
                            >
                            ...
                            <a
                                ...
                                className={`flex items-center px-3 py-2 mt-2 rounded-md ${
                                    selectedCategory === "files" ? "bg-primary text-white" : ""
                                }`}
                            >
                  ...
                  <span className="w-5 h-5 flex items-center justify-center">
                    ...
                    <div className="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-5">
                        {filteredFiles.length === 0 ? (
                            // If filteredFiles array is empty, show the message
                            <div className="col-span-12">
                                <div className="w-full h-64 flex items-center justify-center text-gray-600">
                                    No files found for {selectedCategory}.
                                </div>
                            </div>
                        ) : (
                            filteredFiles.map((file, fakerKey) => (
                                <div
                                    key={fakerKey}
                                ...
                                >
                                    <div className="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                                        ...
                                        {(() => {
                                            ...
                                            else if (file.files[0].type === "Folder")
                                                return (
                                                    <a
                                                        href=""
                                            ...
                                            else if (file.files[0].type === "Image")
                                                return (
                                                    <a
                                                        href=""
                                        ...
                                        <a href="" className="block font-medium mt-4 text-center truncate">
                                            {file.files[0].fileName.split("/").pop()}
                                        </a>
                                        ...
                                        <Dropdown className="absolute top-0 right-0 mr-2 mt-3 ml-auto">
                                            ...
                                            <DropdownMenu className="w-40">
                                                <DropdownContent>
                                                    <DropdownItem>
                                                        <Lucide icon="Users" className="w-4 h-4 mr-2" /> Share File
                                                    </DropdownItem>
                                                    <DropdownItem>
